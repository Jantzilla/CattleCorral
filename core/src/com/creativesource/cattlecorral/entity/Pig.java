...
public class Pig extends Animal {
    public Pig(PlayScreen screen, Animation up, Animation left, Animation down, Animation right, float worldWidth, ArrayList<TiledMapTileLayer> tiledMapTileLayers, int startPosition) {
